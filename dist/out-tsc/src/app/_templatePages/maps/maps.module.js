...
var MapsModule = /** @class */ (function () {
    ...
    MapsModule = __decorate([
        core_1.NgModule({
            imports: [common_1.CommonModule, router_1.RouterModule.forChild(maps_routing_1.MapRoutes), core_2.AgmCoreModule],
            declarations: [map_google_component_1.MapgoogleComponent]
        })
    ], MapsModule);
    return MapsModule;
}());
