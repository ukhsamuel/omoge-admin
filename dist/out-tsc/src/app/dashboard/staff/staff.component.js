...
var StaffComponent = /** @class */ (function () {
    function StaffComponent(_loadingBar, modalService, rest) {
        var _this = this;
    ...
    StaffComponent_1 = StaffComponent;
    StaffComponent.prototype.ngOnInit = function () {
        this.getStaff();
    };
    StaffComponent.prototype.revoke = function (row) {
        var _this = this;
        var modalRef = this.modalService.open(RevokeStaffModalContent);
    ...
    StaffComponent.prototype.getStaff = function () {
        ...
        this.rest.getStaff().subscribe(function (response) {
            _this._loadingBar.complete();
            _this.staff = response.json().data;
    ...
    StaffComponent.prototype.updateFilter = function (event) {
        ...
        this.table = this.staff;
    };
    var StaffComponent_1;
    __decorate([
        core_1.ViewChild(StaffComponent_1),
        __metadata("design:type", StaffComponent)
    ], StaffComponent.prototype, "table", void 0);
    StaffComponent = StaffComponent_1 = __decorate([
        core_1.Component({
            selector: 'app-staff',
...
var RevokeStaffModalContent = /** @class */ (function () {
    function RevokeStaffModalContent(activeModal, formBuilder, rest) {
    ...
    RevokeStaffModalContent.prototype.ngOnInit = function () {
    };
    RevokeStaffModalContent.prototype.delete = function () {
        var _this = this;
    ...
    ], RevokeStaffModalContent.prototype, "name", void 0);
    RevokeStaffModalContent = __decorate([
        core_1.Component({
    ...
    ], RevokeStaffModalContent);
    return RevokeStaffModalContent;
}());
exports.RevokeStaffModalContent = RevokeStaffModalContent;
